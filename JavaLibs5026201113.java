...
public class Main {
    ...
    public static void main(String[] args) {
		...
		int favnumber = Integer.parseInt(JOptionPane.showInputDialog(null,"What about your favourite number?"));
		int total = favnumber + tall;
		...
		JOptionPane.showMessageDialog(null,"So I went for a holiday with " + input2 + " and we went for a dinner on " + input3
